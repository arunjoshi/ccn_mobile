...
import 'package:news_app/pages/privacy_policy.dart';
import 'package:news_app/pages/sign_up.dart';
import 'package:news_app/pages/terms_conditions.dart';
            ...
            Container(
              ...
              child: RichText(
                text: TextSpan(
                    ...
                    text: "By Continuing you indicate that you agree to City Chief's ",

                    children: <TextSpan>[
                      TextSpan(text: 'Terms & Conditions ',
                        style: TextStyle(fontFamily: 'Manrope',color: Colors.red, fontWeight: FontWeight.bold,),
                        recognizer: TapGestureRecognizer()..onTap=()=>nextScreen(context, TermsConditionsPage()),
                      ),
                      TextSpan(text: 'and ',
                        style: TextStyle(color: Colors.black,fontFamily: 'Manrope',),),
                      TextSpan(text: 'Privacy Policy',
                        style: TextStyle(color: Colors.red, fontFamily: 'Manrope',fontWeight: FontWeight.bold,),
                        recognizer: TapGestureRecognizer()..onTap=()=>nextScreen(context, PrivacyPolicyPage()),
                      )
                    ]
                ),
              ),
